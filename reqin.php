...
// require "file.php"; 
// require "file.php"; 
//the require will continue to execute as long as it is called and the file is available, as seen above
...
//require overwrites the additional code written to complement the required files. see below
// require "file.php";
// $x++;
// echo $x . "<br>";//output: 6
